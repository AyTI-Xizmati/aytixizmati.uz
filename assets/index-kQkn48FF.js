...
`),ee=R.split(`
`);for(d=l=0;l<B.length&&!B[l].includes("DetermineComponentFrameRoot");)l++;for(;d<ee.length&&!ee[d].includes("DetermineComponentFrameRoot");)d++;if(l===B.length||d===ee.length)for(l=B.length-1,d=ee.length-1;1<=l&&0<=d&&B[l]!==ee[d];)d--;for(;1<=l&&0<=d;l--,d--)if(B[l]!==ee[d]){if(l!==1||d!==1)do if(l--,d--,0>d||B[l]!==ee[d]){var he=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ea,depthTest:!1,depthWrite:!1})}function ax(){return new Oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Uc(),fragmentShader:`
		...
		`,blending:Ea,depthTest:!1,depthWrite:!1})}function rx(){return new Oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Uc(),fragmentShader:`
